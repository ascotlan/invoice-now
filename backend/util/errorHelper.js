...
/**
 * Thrown when Invoice Status is not valid.
 * @class
 */
class InvalidInvoiceStatusError extends Error {
  constructor(message, statusCode) {
    super(message);
    this.statusCode = statusCode;
    this.name = this.constructor.name;
...
module.exports = { UserNotAuthorizedError, UserNotFoundError, InvoiceNotFoundError, InvoiceItemNotFoundError, InvalidInvoiceStatusError };